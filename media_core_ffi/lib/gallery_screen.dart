...
class _ModelLoaderScreenState extends State<ModelLoaderScreen> {
  ...
  final Map<String, String> _filesToDownload = {
    'decoder_model.onnx':
        'https://huggingface.co/A-16-S/semantic-search-private/resolve/main/decoder_model.onnx',
    'decoder_with_past_model.onnx':
        'https://huggingface.co/A-16-S/semantic-search-private/resolve/main/decoder_with_past_model.onnx',
    'encoder_model.onnx':
        'https://huggingface.co/A-16-S/semantic-search-private/resolve/main/encoder_model.onnx',
    'ppocr_det_fp32.onnx':
        'https://huggingface.co/A-16-S/semantic-search-private/resolve/main/ppocr_det_fp32.onnx',
    'ppocr_rec_fp32.onnx':
        'https://huggingface.co/A-16-S/semantic-search-private/resolve/main/ppocr_rec_fp32.onnx',
    'siglip.onnx':
        'https://huggingface.co/A-16-S/semantic-search-private/resolve/main/siglip.onnx',
    'tokenizer.json':
        'https://huggingface.co/A-16-S/semantic-search-private/resolve/main/tokenizer.json',
  };
  ...
  Future<void> _downloadModels() async {
    ...
    try {
      ...
      for (int i = 0; i < keys.length; i++) {
        ...
        setState(() {
          _status =
              "Downloading $fileName (${i + 1}/${_filesToDownload.length})...";
      ...
      body: Center(
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: const Color(0xFF00F5FF).withOpacity(0.2), width: 1),
            boxShadow: [
              BoxShadow(
...
class _GalleryDashboardScreenState extends State<GalleryDashboardScreen> {
  ...
  String _activeTab =
      "All Files"; // "All Files", "Photos", "Videos", "Smart Albums"
  ...
  void _initService() {
    FlutterForegroundTask.init(
      androidNotificationOptions: AndroidNotificationOptions(
        ...
        channelDescription:
            'Processes video summaries in high-priority native service threads.',
        onlyAlertOnce: true,
      ),
    ...
    for (var file in files) {
      ...
      if (path.endsWith('.mp4') ||
        ...
        final photo = IndexedPhoto(
          ...
          indexedTime: DateTime.now(),
          embedding512:
              List<double>.generate(512, (_) => rand.nextDouble() * 2 - 1),
      ...
      if (ps.isAuth) {
        ...
        for (var pathEntity in paths) {
          final List<AssetEntity> assets =
              await pathEntity.getAssetListRange(start: 0, end: 50);
  ...
  void _performSearch() {
    ...
    for (var photo in _scannedPhotos) {
      ...
      if (photo.detectedObjects.toLowerCase().contains(query) ||
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        labelStyle: const TextStyle(
                            color: Color(0xFF00F5FF), fontSize: 12),
              ...
              children: [
                ...
                ListTile(
                  leading: const Icon(Icons.play_circle_fill,
                      color: Color(0xFF39FF14)),
                  title: const Text("Play Media & Interactive Summary",
                ...
                ListTile(
                  ...
                  title: const Text("Run Immediate Foreground Summary",
                      style: TextStyle(fontFamily: 'Inter')),
                  subtitle: const Text(
                      "Launches native foreground service notification summary",
                ...
                ListTile(
                  ...
                  title: Text("Queue Native $_processDepth Pipeline",
                      style: const TextStyle(fontFamily: 'Inter')),
                  subtitle: const Text(
                      "Orchestrates background worker on Isolate Thread",
                      style: TextStyle(fontSize: 11, color: Colors.grey)),
                  onTap: () {
                    Navigator.pop(context);
                    _runBackgroundIngestion(video);
  ...
  Future<void> _runForegroundServiceSummary(IndexedVideo video) async {
    ...
    if (Platform.isAndroid) {
      await FlutterForegroundTask.startService(
        ...
        notificationText:
            'Extracting transcript and OCR frames from ${video.fileName}',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("NEURAL CINEMA ENGINE",
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const ControlSettingsScreen()));
            },
          ),
          IconButton(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText:
                          "Search visual semantics, transcripts & OCR text...",
                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        const Text("ACTIVE PIPELINE WORKER ISOLATE Running...",
                            style: TextStyle(
                                fontFamily: 'JetBrains Mono',
                                fontSize: 11,
            ...
            Row(
              children:
                  ["All Files", "Photos", "Videos", "Smart Albums"].map((tab) {
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            fontWeight: FontWeight.bold,
                            color:
                                active ? const Color(0xFF00F5FF) : Colors.grey,
                            fontSize: 13,
                          ),
                        ),
  ...
  Widget _buildSelectedTabContent() {
    if (_activeTab == "All Files") {
      ...
      combined.sort((a, b) {
        final DateTime timeA = (a is IndexedPhoto)
            ? a.indexedTime
            : (a as IndexedVideo).indexedTime;
        final DateTime timeB = (b is IndexedPhoto)
            ? b.indexedTime
            : (b as IndexedVideo).indexedTime;
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color: const Color(0xFF39FF14), width: 1),
                        borderRadius: BorderRadius.circular(4),
                      ),
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color: const Color(0xFF00F5FF), width: 1),
                        borderRadius: BorderRadius.circular(4),
                      ),
          ...
          child: ListTile(
            ...
            title: Text(name,
                style: const TextStyle(
                    ...
                    fontWeight: FontWeight.bold,
                    color: Colors.white)),
            subtitle: Text("Dynamic semantic filter: '$query'",
                style: const TextStyle(
                    fontFamily: 'JetBrains Mono',
                    fontSize: 11,
                    color: Colors.grey)),
                ...
                TextButton(
                  onPressed: () {
                    ...
                    if (q.isNotEmpty && !_smartAlbums.containsKey(q)) {
                      setState(() {
                        _smartAlbums[q] =
                            "${q.substring(0, 1).toUpperCase()}${q.substring(1)} Album 📁";
                      });
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          backgroundColor: const Color(0xFF1C1B1B),
                          content: Text("Saved '$q' as a dynamic Smart Album!",
                              style: const TextStyle(
                                  color: Color(0xFF39FF14),
                                  fontFamily: 'JetBrains Mono')),
                        ),
                  ...
                  child: ListTile(
                    leading: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color: const Color(0xFF39FF14), width: 0.5),
                        borderRadius: BorderRadius.circular(4),
                      ),
                      child: const Center(
                  ...
                  child: ListTile(
                    leading: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color: const Color(0xFF00F5FF), width: 0.5),
                        borderRadius: BorderRadius.circular(4),
                      ),
                      child: const Center(
            ...
            child: Column(
              ...
              children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                const Icon(Icons.image,
                                    size: 80, color: Color(0xFF39FF14)),
                                const SizedBox(height: 12),
                                Text(
                                  photo.filePath,
                                  textAlign: TextAlign.center,
                ...
                Text(
                  ...
                  style: const TextStyle(
                      fontFamily: 'Inter', fontSize: 11, color: Colors.grey),
                ),
              ],
            ),
          ),
...
class VideoPlayerScreen extends StatefulWidget {
  ...
  const VideoPlayerScreen(
      {Key? key, required this.video, this.activeFrame, this.queryText})
      : super(key: key);
                        ...
                        builder: (context, constraints) {
                          ...
                          return Stack(
                            children: queryMatchTimestamps.map((ms) {
                              ...
                              final double posX =
                                  ratio * (width - 24) + 12; // Adjusted padding
                              return Positioned(
                                left: posX - 4,
                                top: 0,
                                bottom: 0,
                ...
                child: TextButton(
                  style: TextButton.styleFrom(
                    foregroundColor:
                        active ? const Color(0xFF00F5FF) : Colors.grey,
                    backgroundColor:
                        active ? const Color(0xFF1C1B1B) : Colors.transparent,
                    shape: const RoundedRectangleBorder(),
                  ),
                  onPressed: () {
                    setState(() {
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: const TextStyle(
                  fontFamily: 'Inter', fontSize: 10, color: Colors.white),
            )
          ],
        ),
      ),
  ...
  Widget _buildTabContent() {
    if (_activeTab == "Extractive Summary") {
      ...
      return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text("OFFLINE EXTRACTIVE TEXTRANK MATRIX (TOP SENTENCES)",
              style: TextStyle(
                  fontFamily: 'JetBrains Mono',
                  fontSize: 11,
                  color: Color(0xFF39FF14))),
      ...
      if (_transcripts.isEmpty) {
        return const Center(
            child: Text("No transcript indexed for this video.",
      ...
      return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text("WHISPER TRANSLATED SENTENCES (TAP TO JUMP)",
              style: TextStyle(
                  fontFamily: 'JetBrains Mono',
                  fontSize: 11,
                  color: Colors.grey)),
                  ...
                  child: Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        fontSize: 13,
                        color:
                            isCurrent ? const Color(0xFF00F5FF) : Colors.white,
                        fontWeight:
      ...
      return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text("PP-OCR TEXT DETECTION TELEMETRY (TAP TO JUMP)",
              style: TextStyle(
                  fontFamily: 'JetBrains Mono',
                  fontSize: 11,
                  color: Colors.grey)),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
                "Coords: [[102, 240], [180, 240], [180, 255], [102, 255]] | Jump target: ${jumpMs ~/ 1000}s",
                style: const TextStyle(
                    fontFamily: 'JetBrains Mono',
                    color: Colors.grey,
                    fontSize: 10)),
...
class _ControlSettingsScreenState extends State<ControlSettingsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("NEURAL COMPUTE SYSTEM",
            style: TextStyle(fontFamily: 'Sora', fontWeight: FontWeight.bold)),
        backgroundColor: const Color(0xFF131313),
      ),
      body: ListView(
        padding: const EdgeInsets.all(16),
        children: [
          const Text("ON-DEVICE RESOURCE ALLOCATION",
              style: TextStyle(
                  fontFamily: 'JetBrains Mono',
                  fontSize: 12,
                  color: Color(0xFF00F5FF))),
          ...
          Card(
            ...
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text("ACTIVE RUNTIME MEMORY LIMIT (CRITICAL BUDGET)",
                      style: TextStyle(
                          fontFamily: 'JetBrains Mono', fontSize: 11)),
                  const SizedBox(height: 8),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("${_ramCeiling.toStringAsFixed(1)} GB",
                          style: const TextStyle(
                              fontFamily: 'Sora',
                              fontSize: 20,
                              color: Color(0xFF39FF14),
                              fontWeight: FontWeight.bold)),
                      const Text("CEILING BUDGET: 1.5 GB",
                          style: TextStyle(
                              fontFamily: 'JetBrains Mono',
                              fontSize: 10,
                              color: Colors.red)),
          ...
          SwitchListTile(
            title: const Text("Isolate Thread Ingestion Workers",
                style: TextStyle(fontFamily: 'Sora')),
            subtitle: const Text(
                "Offloads non-blocking FFI extraction pipelines to auxiliary thread loops",
          ...
          const Text("WINDOWS WATCHED DIRECTORIES",
              style: TextStyle(
                  fontFamily: 'JetBrains Mono',
                  fontSize: 12,
                  color: Color(0xFF00F5FF))),
                ...
                children: [
                  ...
                  DatabaseManager.getWatchedDirectories().isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemCount:
                              DatabaseManager.getWatchedDirectories().length,
                          itemBuilder: (context, idx) {
                            final path =
                                DatabaseManager.getWatchedDirectories()[idx];
                            return Card(
                              color: const Color(0xFF131313),
                              ...
                              child: ListTile(
                                ...
                                trailing: IconButton(
                                  ...
                                  onPressed: () {
                                    setState(() {
                                      DatabaseManager.removeWatchedDirectory(
                                          path);
                                    });
                                  },
                                ),
          ...
          const SizedBox(height: 8),
          const ListTile(
            title: Text("ObjectBox DB Store Dimension",
                style: TextStyle(fontSize: 14)),
            trailing: Text("512-dim (FP32 locked)",
                style: TextStyle(
                    fontFamily: 'JetBrains Mono', color: Color(0xFF00F5FF))),
          ),
          const ListTile(
            title: Text("Device Architecture Core",
                style: TextStyle(fontSize: 14)),
            trailing: Text("Flutter + C++ FFI (100% Offline)",
                style: TextStyle(
                    fontFamily: 'JetBrains Mono', color: Color(0xFF39FF14))),
          ),
        ],
      ),
    );
...
class _TimelineScreenState extends State<TimelineScreen> {
  final TextEditingController _temporalQueryController =
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("TIMELINE INTELLIGENCE",
            style: TextStyle(fontFamily: 'Sora', fontWeight: FontWeight.bold)),
        backgroundColor: const Color(0xFF131313),
      ),
      body: Padding(
        ...
        child: Column(
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                hintText:
                    "Ask temporal queries (e.g. Summarize what I did last month)...",
                fillColor: const Color(0xFF1C1B1B),
                filled: true,
                border:
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            leading: const Icon(Icons.schedule,
                                color: Color(0xFF00F5FF)),
                            title: Text(_mappedMemories[idx],
                                style: const TextStyle(
